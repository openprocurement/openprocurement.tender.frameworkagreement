...
class TenderLotResourceTest(BaseFrameworkagreementContentWebTest, TenderLotResourceTestMixin, TenderLotValueTestMixin):
...
class TenderLotEdgeCasesTest(BaseFrameworkagreementContentWebTest, TenderLotEdgeCasesTestMixin):
    initial_auth = ('Basic', ('broker', ''))
...
class TenderLotFeatureResourceTest(BaseFrameworkagreementContentWebTest, TenderLotFeatureResourceTestMixin):
...
class TenderLotBidderResourceTest(BaseFrameworkagreementContentWebTest):
...
class TenderLotFeatureBidderResourceTest(BaseFrameworkagreementContentWebTest):
    initial_lots = test_lots
    initial_auth = ('Basic', ('broker', ''))
    initial_data = test_tender_data
    test_bids_data = test_bids  # TODO: change attribute identifier
...
class TenderLotProcessTest(BaseFrameworkagreementContentWebTest, TenderLotProcessTestMixin):
    setUp = BaseFrameworkagreementContentWebTest.setUp
    test_lots_data = test_lots  # TODO: change attribute identifier
    initial_data = test_tender_data
    test_bids_data = test_bids  # TODO: change attribute identifier
