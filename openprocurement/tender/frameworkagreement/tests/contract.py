...
class TenderContractResourceTest(BaseFrameworkagreementContentWebTest, TenderContractResourceTestMixin):
...
class TenderContractDocumentResourceTest(BaseFrameworkagreementContentWebTest,
                                         TenderContractDocumentResourceTestMixin):
    initial_status = 'active.qualification'
    initial_bids = test_bids
    initial_auth = ('Basic', ('broker', ''))
