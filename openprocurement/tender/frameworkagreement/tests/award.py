...
class TenderAwardResourceTest(BaseFrameworkagreementContentWebTest,
                              TenderAwardResourceTestMixin):
...
class TenderLotAwardResourceTest(BaseFrameworkagreementContentWebTest,
                                 TenderLotAwardResourceTestMixin):
    initial_status = 'active.tendering'
    initial_bids = test_bids
    initial_lots = test_lots
...
class Tender2LotAwardResourceTest(BaseFrameworkagreementContentWebTest,
                                  Tender2LotAwardResourceTestMixin):
    initial_status = 'active.tendering'
...
class TenderAwardComplaintResourceTest(BaseFrameworkagreementContentWebTest,
                                       TenderAwardComplaintResourceTestMixin,
...
class TenderLotAwardComplaintResourceTest(BaseFrameworkagreementContentWebTest,
                                          TenderLotAwardComplaintResourceTestMixin):
    # initial_data = tender_data
    initial_status = 'active.tendering'
    initial_lots = test_lots
...
class TenderAwardComplaintDocumentResourceTest(BaseFrameworkagreementContentWebTest,
                                               TenderAwardComplaintDocumentResourceTestMixin):
...
class Tender2LotAwardComplaintDocumentResourceTest(BaseFrameworkagreementContentWebTest):
    initial_status = 'active.qualification'
    initial_bids = test_bids
    initial_lots = 2 * test_lots
...
class TenderAwardDocumentResourceTest(BaseFrameworkagreementContentWebTest,
                                      TenderAwardDocumentResourceTestMixin):
    initial_status = 'active.qualification'
    initial_bids = test_bids
...
class Tender2LotAwardDocumentResourceTest(BaseFrameworkagreementContentWebTest,
                                          Tender2LotAwardDocumentResourceTestMixin):
    initial_status = 'active.qualification'
    initial_bids = test_bids
    initial_lots = 2 * test_lots
